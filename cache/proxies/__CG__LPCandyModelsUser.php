 ...
 */
class User extends \LPCandy\Models\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = array('identities' => NULL, 'name' => NULL, 'phone' => NULL, 'city' => NULL, 'address' => NULL, 'address_extra' => NULL, 'login' => NULL, 'password' => NULL, 'email' => '', 'secret' => '');
    ...
    {
        unset($this->identities, $this->name, $this->phone, $this->city, $this->address, $this->address_extra, $this->login, $this->password, $this->email, $this->secret);
    ...
    public function logout()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'logout', array());
