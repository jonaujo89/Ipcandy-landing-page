 ...
 */
class PageData extends \LPCandy\Models\PageData implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = array('custom_fields' => NULL, 'page' => NULL);
    ...
    {
        unset($this->custom_fields, $this->page);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'custom_fields', 'page');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PageData $proxy) {
