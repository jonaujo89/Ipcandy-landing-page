...
namespace Bingo\Proxies\__CG__\CMS\Models;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \CMS\Models\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = array('login' => NULL, 'password' => NULL, 'email' => '', 'secret' => '');
    ...
    {
        unset($this->login, $this->password, $this->email, $this->secret);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'login', 'password', 'email', 'secret');
        }
