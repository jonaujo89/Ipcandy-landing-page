...
class Page extends \LPCandy\Models\Page implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     */
    public static $lazyPropertiesDefaults = array('title' => NULL, 'domain' => NULL, 'pathname' => NULL, 'meta_robots' => NULL, 'meta_keywords' => NULL, 'meta_description' => NULL, 'extra_html' => NULL, 'form' => NULL, 'parent' => NULL, 'children' => NULL, 'user' => NULL);
    ...
    {
        unset($this->title, $this->domain, $this->pathname, $this->meta_robots, $this->meta_keywords, $this->meta_description, $this->extra_html, $this->form, $this->parent, $this->children, $this->user);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'title', 'domain', 'pathname', 'meta_robots', 'meta_keywords', 'meta_description', 'extra_html', 'form', 'parent', 'children', 'user');
        }
