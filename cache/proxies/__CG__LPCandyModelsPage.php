...
class Page extends \LPCandy\Models\Page implements \Doctrine\ORM\Proxy\Proxy
{
     ...
     */
    public static $lazyPropertiesDefaults = array('title' => NULL, 'domain' => NULL, 'form' => NULL, 'parent' => NULL, 'children' => NULL, 'user' => NULL);
    ...
    {
        unset($this->title, $this->domain, $this->form, $this->parent, $this->children, $this->user);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'title', 'domain', 'form', 'parent', 'children', 'user');
        }
