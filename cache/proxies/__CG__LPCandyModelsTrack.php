 ...
 */
class Track extends \LPCandy\Models\Track implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     */
    public static $lazyPropertiesDefaults = array('data' => NULL, 'date' => NULL, 'ip' => NULL, 'status' => NULL, 'page' => NULL, 'page_title' => NULL, 'user' => NULL);
    ...
    {
        unset($this->data, $this->date, $this->ip, $this->status, $this->page, $this->page_title, $this->user);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'data', 'date', 'ip', 'status', 'page', 'page_title', 'user');
        }
