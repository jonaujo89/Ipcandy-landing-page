...
class Page extends Base {
    ...
    function page_form($page) {
        ...
        if ($page->parent) {
            ...
            $form->text('domain',_t('Domain (bind your domain to our server IP:').$_SERVER['SERVER_ADDR'].')',$this->domain_validator($page),$page->domain);
        }
        ...
        $form->checkbox('is_responsive',_t('Responsive page design'),'',$page->is_responsive);
        $form->fieldset();
