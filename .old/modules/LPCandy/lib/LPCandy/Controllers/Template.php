...
class Template extends Base {
    ...
    function tpl_list() {
        ...
        $this->data['page_actions']['tpl-editor'] = _t('File editor');
    ...
    function tpl_editor() {
        $this->data['title'] = _t('Template editor');
        $this->view('lpcandy/tpl-editor');
    }
    
    function tpl_editor_ajax() {
        if (!isset($_REQUEST['_type'])) return;
        $api = new \LPCandy\DaysideApi($this->user);
    }
}