...
<? startblock('content') ?>
    ...
    <iframe src="http://loginza.ru/api/widget?overlay=loginza&lang=ru&token_url=<?=$full?>" style="display:block;margin:0 auto;width:359px;height:300px;" scrolling="no" frameborder="no">
