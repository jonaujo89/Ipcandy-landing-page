var opts = {
    ...
    items:[{
        type: 'text', name: 'label', label: '<b>Field Label</b><br>This is the name which will appear on the EDIT page'
    },{
        type: 'text', name: 'name',  label: '<b>Field Name</b><br>Single word, no spaces. Underscores and dashes allowed'
    },{
        type: 'switcher', showSelect: true, label: "<b>Field Type</b>",
        repository: {
            text: {
                label: 'Text',
                items: [{
                    type: 'text', label: '<b>Instructions</b><br>Instructions for authors. Shown when submitting data'
                },{
                    type: 'text', name: 'default', label: '<b>Default value</b>'
                }]
            },
            textarea: {
                label: 'Textarea',
                items: [{
                    ...
                    type: 'textarea', name: 'default', label: '<b>Default value</b>'
                }]
            },
            wysiwyg: {
            ...
            repeater: {
                ...
                items: [{
                    ...
                    type: 'formRepeater', label: '<b>Fields</b>', name: 'fields', addLabel: '+ Add Sub Field'
                }]
            }
        }
    }]
