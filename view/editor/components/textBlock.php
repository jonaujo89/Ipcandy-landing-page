        ...
        return  array(
            ...
            'items' => array(
                array(
                    ...
                    'text' => ' <div>Супер четверка в составе льва, жирафа, бегемота и зебры станут для вас сенсацией. Животные эквилибристы будут порхать под куполом цирка, даря вам несравненные ни с чем эмоции.</div>
                                <br>
                                <div>
                                    - Отличный сюжет<br>
                                    - Супер костюмы<br>
