lp.textBlock = lp.block.extendOptions({
    ...
    configForm: {
        items: [   
            ...
            { 
                name: "show_list", label: _t("Show list"), type: "check", width: "auto",  
                margin: "5px 49% 0px 0px", showWhen: { variant: [1] }
            },
            { 
                name: "show_name", label: _t("Show name cell"), type: "check", width: "auto",  
                margin: "5px 49% 0px 0px", showWhen: { variant: [2] }
            },
            { 
                name: "show_text_title_2", label: _t("Show description cell"), type: "check", width: "auto",  
                margin: "5px 49% 0px 0px", showWhen: { variant: [4,6] }
            },
            { 
                name: "show_border", label: _t("Show border from image"), type: "check", width: "auto",  
