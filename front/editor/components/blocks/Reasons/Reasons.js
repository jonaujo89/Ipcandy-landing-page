...
class Reasons extends Block {
    ...
    tpl_default_1(val) {
        return window.locale_lang == 'en' ? {
            ...
            items: [
                {
                    icon_1: `${lp.app.options.assets_url}/ico/799.png`,
                    icon_2: `${lp.app.options.assets_url}/ico/806.png`,
                    name_1: "Funny clowns",
                ...
                {
                    icon_1: `${lp.app.options.assets_url}/ico/341.png`,
                    icon_2: `${lp.app.options.assets_url}/ico/359.png`,
                    name_1: "Acrobatics",
                ...
                {
                    icon_1: `${lp.app.options.assets_url}/ico/342.png`,
                    icon_2: `${lp.app.options.assets_url}/ico/252.png`,
