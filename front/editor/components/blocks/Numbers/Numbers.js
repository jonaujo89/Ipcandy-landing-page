...
class Numbers extends Block {
    ...
    tpl_default_3(val) {
        return window.locale_lang == 'en' ? {
            show_title: false,
            show_title_2: false,
            background: {url:`${lp.app.options.assets_url}/texture_black/1.jpg`},
            title: 'Circus facts',
            title_2: 'Subtitle',
            items: [
                {
    ...
    tpl_default_4(val) {
        return window.locale_lang == 'en' ? {
            ...
            items: [
                {
                    icon_1: `${lp.app.options.assets_url}/ico/101.png`,
                    value_1: '5000',
                    name_1: 'Diplomas',
                    icon_2: `${lp.app.options.assets_url}/ico/99.png`,
                    value_2: '20',
                    name_2: 'Satisfied visitors',
                    icon_3: `${lp.app.options.assets_url}/ico/178.png`,
                    value_3: '50',
                    name_3: 'Pour out in the cafeteria',
                    icon_4: `${lp.app.options.assets_url}/ico/739.png`,
                    value_4: '350',
    ...
    tpl_default_5(val) {
        return window.locale_lang == 'en' ? {
            ...
            items: [
                {
                    icon_1: `${lp.app.options.assets_url}/ico/491.png`,
                    value_1: '1',
                    name_1: 'Ttrained tiger',
                    icon_2: `${lp.app.options.assets_url}/ico/447.png`,
                    value_2: '750',
                    name_2: 'Loving audience',
                    icon_3: `${lp.app.options.assets_url}/ico/379.png`,
                    value_3: '80',
                    name_3: 'Ticket price',
                    icon_4: `${lp.app.options.assets_url}/ico/645.png`,
                    value_4: '3',
    ...
    tpl_default_6(val) {
        return window.locale_lang == 'en' ? {
            ...
            items: [
                    {
                        icon_1: `${lp.app.options.assets_url}/ico/648.png`,
                        value_1: '50',
                        name_1: 'UNNECESSARY SCHEDULES',
                        icon_2: `${lp.app.options.assets_url}/ico/684.png`,
                        value_2: '15',
                        name_2: 'HANGER IN THE DRESSING ROOM',
                        icon_3: `${lp.app.options.assets_url}/ico/501.png`,
                        value_3: '85',
                        name_3: 'ENERGIZED LAMPS',
                        icon_4: `${lp.app.options.assets_url}/ico/624.png`,
                        value_4: '20',
    ...
    tpl_default_7(val) {
        return window.locale_lang == 'en' ? {
            ...
            items: [
                {
                    icon_1: `${lp.app.options.assets_url}/ico/596.png`,
                    value_1: '10',
                    name_1: 'Talking parrots',
                    icon_2: `${lp.app.options.assets_url}/ico/620.png`,
                    value_2: '22',
                    name_2: 'Balloon',
                    icon_3: `${lp.app.options.assets_url}/ico/396.png`,
                    value_3: '85',
                    name_3: 'Fluttering butterflies',
                    icon_4: `${lp.app.options.assets_url}/ico/696.png`,
                    value_4: '1',
