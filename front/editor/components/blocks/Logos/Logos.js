...
class Logos  extends Block {
    ...
    tpl_default_1() { 
       return window.locale_lang == 'en' ? {
            ...
            items: [
                {image: `${lp.app.options.assets_url}/logos/1.png`},
                {image: `${lp.app.options.assets_url}/logos/2.png`},
                {image: `${lp.app.options.assets_url}/logos/3.png`},
                {image: `${lp.app.options.assets_url}/logos/4.png`},
                {image: `${lp.app.options.assets_url}/logos/5.png`},
                {image: `${lp.app.options.assets_url}/logos/6.png`},
                {image: `${lp.app.options.assets_url}/logos/7.png`},
                {image: `${lp.app.options.assets_url}/logos/8.png`},
                {image: `${lp.app.options.assets_url}/logos/9.png`},
                {image: `${lp.app.options.assets_url}/logos/11.png`},
                {image: `${lp.app.options.assets_url}/logos/12.png`},
            ],
        } : {            
            show_title: true,
            show_title_2: false,
