...
class Services extends Block {
    ...
    tpl_default_1() {
        return window.locale_lang == 'en' ? {
            ...
            items: [
                {
                    image_1: `${lp.app.options.assets_url}/services/1.jpg`,
                    image_2: `${lp.app.options.assets_url}/services/2.jpg`,
                    image_3: `${lp.app.options.assets_url}/services/3.jpg`,
                    name_1: "Smiling dog",
    ...
    tpl_default_2() {
        return window.locale_lang == 'en' ? { 
            ...
            items: [
                {
                    image_1: `${lp.app.options.assets_url}/services/4.jpg`,
                    image_2: `${lp.app.options.assets_url}/services/5.jpg`,
                    name_1: "KITTEH-DEER",
                    name_2: "DOG-DEER",
    ...
    tpl_default_3(val) {
        return window.locale_lang == 'en' ? {
            ...
            items: [
                {
                    image: `${lp.app.options.assets_url}/services/12.jpg`,
                    name: "CONJURER FEDOR",
    ...
    tpl_default_4(val) {
        return window.locale_lang == 'en' ? {
            ...
            items: [
                {
                    image_1: `${lp.app.options.assets_url}/ico/772.png`,
                    image_2: `${lp.app.options.assets_url}/ico/335.png`,
                    image_3: `${lp.app.options.assets_url}/ico/255.png`,
    ...
    tpl_default_5(val) {
        return window.locale_lang == 'en' ? {
            ...
            items: [
                {
                    image_1: `${lp.app.options.assets_url}/services/6.jpg`,
                    image_2: `${lp.app.options.assets_url}/services/7.jpg`,
                    image_3: `${lp.app.options.assets_url}/services/8.jpg`,
                    name_1: "Chess battle",
                    name_2: "Soviet movie",
    ...
    tpl_default_6(val) {
        return window.locale_lang == 'en' ? {
            ...
            items: [
                {
                    image_1: `${lp.app.options.assets_url}/services/9.jpg`,
                    image_2: `${lp.app.options.assets_url}/services/10.jpg`,
                    image_3: `${lp.app.options.assets_url}/services/11.jpg`,
