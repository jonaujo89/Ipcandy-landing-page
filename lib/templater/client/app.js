...
exports = ui.Control.extend({
    ...
    initUI: function () {  
        ...
        toolbar.element.css({zIndex:2,position:'absolute',left:0,width:toolbarWidth,top:0,height:76});
        toolbar.element.addClass("preview-toolbar");
        toolbar.push(
            me.closeButton = ui.button({
                label:_t("Preview"), margin: "21px 0 0 0",
            ...
            me.publishButton = ui.button({
                label:_t("Publish"), margin: "15px 5px 0",
        ...
        var panel = ui.panel();
        panel.element.css({position:'fixed',left:0,top:0,right:0,bottom:20,margin:0}).addClass("editor-panel");
        panel.element.appendTo(teacss.ui.layer);
        panel.push(me.templateTabs,toolbar,sidebar);
        
        me.frame = ui.previewFrame();
        me.frame.element.css({position:"absolute",left:sidebarWidth,right:0,margin:0,top:0,bottom:0}).addClass("frame-panel");
